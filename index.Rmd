...
refreshes every half-hour during the workday. You can [manually refresh](https://github.com/caltechlibrary/irdm-queue-portal/actions/workflows/render.yaml) the table at GitHub. Last updated `r format(Sys.Date(), '%A, %B %d, %Y ')` `r format(Sys.time(), "%S")`
